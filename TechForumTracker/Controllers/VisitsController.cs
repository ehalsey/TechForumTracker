...
namespace TechForumTracker.Controllers
{
    ...
    {
        private readonly TechForumContext _context;

        public VisitsController(TechForumContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VisitId,VisitorBadgeNumber,VisitDate,VisitLocation")] Visit visit)
        {
            if (id != visit.VisitId)
            {
                return NotFound();
